...
def digit_distance(n):
    ...
    if n<10:
        ...
        all_but_last,last2,last=n//10, (n//10)%10,n%10
        return abs(last-last2)+digit_distance(all_but_last)
...
def interleaved_sum(n, f_odd, f_even):
    ...
    def odd_turn(k):
        if k>n:
            ...
            return f_odd(k)+even_turn(k+1)
    def even_turn(k):
        if k>n:
            return 0
        else:
            return f_even(k)+odd_turn(k+1)
    return odd_turn(1)
...
def count_dollars(total):
    ...
    def count_helper(total,bill):
        if total==0:
            ...
            cur_total=count_helper(total-bill,bill)
            next_total=0
            if next_smaller_dollar(bill) != None:
                next_total=count_helper(total,next_smaller_dollar(bill))
            return cur_total+next_total
...
def count_dollars_upward(total):
    ...
    def helper(total,bill):
        if total==0:
            ...
            cur_total=helper(total-bill,bill)
            next_total=0
            if next_larger_dollar(bill) !=None:
                next_total=helper(total,next_larger_dollar(bill))
        return cur_total+next_total
    return helper(total,1)
# print(count_dollars_upward(10))
